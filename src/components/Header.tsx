...
export default function NavBar() {
  ...
  return (
    <header className="bg-[#0f2923] text-white">
        ...
        <div className="flex items-center pt-3">
          ...
          <nav className="hidden md:block flex-1 mx-32">
            <ul className="flex items-center gap-8 text-[15px] font-semibold">
              <li>
                <Link href="/link1" className="hover:opacity-90">
                  Link 1
                </Link>
              </li>
              <li>
                <Link href="/link2" className="hover:opacity-90">
                  Link 2
                </Link>
              </li>
              <li>
                <Link href="/link3" className="hover:opacity-90">
                  Link 3
                </Link>
              </li>
              <li>
                <Link href="/link4" className="hover:opacity-90">
                  Link 4
                </Link>
              </li>
            </ul>
          ...
          <div className="hidden md:flex items-center">
            <div className="flex items-center gap-3 rounded-t-[22px] rounded-b-none bg-[#8af135] px-8 py-2 text-white shadow-[0_10px_24px_rgba(0,0,0,.25)]">
              <Link
                href="/contact"
                className="rounded-full bg-[#0f2923] px-12 py-3 font-bold hover:bg-white hover:text-[#0f2923] transition-colors duration-300"
              >
                Contact
              </Link>
              {/* 3×3 grid */}
